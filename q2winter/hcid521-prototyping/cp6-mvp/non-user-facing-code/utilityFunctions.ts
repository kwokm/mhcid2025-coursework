...
const exampleJson = {
  "Story": {
    "Life Lesson": "It's okay to be different! Your unique qualities are what make you special and wonderful. Embrace who you are, and don't worry about being like everyone else.",
    "Page Contents": [
    ...
    "Two Sentence Summary": "Growly the Tiger can't roar, which makes him sad because all tigers should roar. With the help of his friend, Shelly the Turtle, Growly learns that it's okay to be different and that his quiet voice is special too."
  }
};
